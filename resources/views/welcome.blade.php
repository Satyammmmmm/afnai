...
<section class="hero_section w_100 h_90vh padding_s15 flex gap_s">
    <div class="hero_content w_100 h_100 flex_c flex_cl gap_s">
        ...
        <button class="primary_button w_100"><a href="/rider_registration"><h2 class="white_cl primary_font">Become a Rider <i class="ri-arrow-right-line"></i></h2></a></button>
        <button class="primary_button secondary_button w_100"><a href="/signup"><h2 class="white_cl primary_font">Book a Ride <i class="ri-navigation-fill"></i></h2></a></button>
        </div>
    </div>
